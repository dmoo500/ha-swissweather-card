 ...
 */
const Le = globalThis, at = Le.ShadowRoot && (Le.ShadyCSS === void 0 || Le.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ot = Symbol(), Tt = /* @__PURE__ */ new WeakMap();
let ei = class {
  constructor(e, t, s) {
...
}, Lt = at ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Bi, defineProperty: Gi, getOwnPropertyDescriptor: Fi, getOwnPropertyNames: ji, getOwnPropertySymbols: Vi, getPrototypeOf: qi } = Object, Oe = globalThis, Nt = Oe.trustedTypes, Zi = Nt ? Nt.emptyScript : "", Qi = Oe.reactiveElementPolyfillSupport, ue = (i, e) => i, Ee = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Zi : null;
      break;
  ...
  return t;
} }, lt = (i, e) => !Bi(i, e), Et = { attribute: !0, type: String, converter: Ee, reflect: !1, useDefault: !1, hasChanged: lt };
...
let ee = class extends HTMLElement {
  ...
  static createProperty(e, t = Et) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      ...
      n !== void 0 && Gi(this.prototype, e, n);
    }
  }
  static getPropertyDescriptor(e, t, s) {
    const { get: n, set: r } = Fi(this.prototype, e) ?? { get() {
      return this[t];
    }, set(a) {
      this[t] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ue("properties"))) {
      const t = this.properties, s = [...ji(t), ...Vi(t)];
  ...
  requestUpdate(e, t, s) {
    if (e !== void 0) {
      ...
      if (s ??= n.getPropertyOptions(e), !((s.hasChanged ?? lt)(r, t) || s.useDefault && s.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, s)))) return;
      this.C(e, t, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct = globalThis, Re = ct.trustedTypes, Rt = Re ? Re.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ii = "$lit$", B = `lit$${Math.random().toFixed(9).slice(2)}$`, ni = "?" + B, Yi = `<${ni}>`, Y = document, me = () => Y.createComment(""), ye = (i) => i === null || typeof i != "object" && typeof i != "function", ht = Array.isArray, Ki = (i) => ht(i) || typeof i?.[Symbol.iterator] == "function", qe = `[ 	
\f\r]`, ce = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Pt = /-->/g, Wt = />/g, j = RegExp(`>|${qe}(?:([^\\s"'>=/]+)(${qe}*=${qe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zt = /'/g, Ht = /"/g, si = /^(?:script|style|textarea|title)$/i, ri = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), p = ri(1), P = ri(2), te = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), Ut = /* @__PURE__ */ new WeakMap(), q = Y.createTreeWalker(Y, 129);
function ai(i, e) {
...
const Xi = (i, e) => {
  ...
  for (let o = 0; o < t; o++) {
    const l = i[o];
    let c, h, d = -1, f = 0;
    for (; f < l.length && (a.lastIndex = f, h = a.exec(l), h !== null); ) f = a.lastIndex, a === ce ? h[1] === "!--" ? a = Pt : h[1] !== void 0 ? a = Wt : h[2] !== void 0 ? (si.test(h[2]) && (n = RegExp("</" + h[2], "g")), a = j) : h[3] !== void 0 && (a = j) : a === j ? h[0] === ">" ? (a = n ?? ce, d = -1) : h[1] === void 0 ? d = -2 : (d = a.lastIndex - h[2].length, c = h[1], a = h[3] === void 0 ? j : h[3] === '"' ? Ht : zt) : a === Ht || a === zt ? a = j : a === Pt || a === Wt ? a = ce : (a = j, n = void 0);
    const u = a === j && i[o + 1].startsWith("/>") ? " " : "";
    r += a === ce ? l + Yi : d >= 0 ? (s.push(c), l.slice(0, d) + ii + l.slice(d) + B + u) : l + B + (d === -2 ? o : u);
  }
  return [ai(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), s];
};
let Xe = class oi {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let r = 0, a = 0;
    const o = e.length - 1, l = this.parts, [c, h] = Xi(e, t);
    if (this.el = oi.createElement(c, s), q.currentNode = this.el.content, t === 2 || t === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (n = q.nextNode()) !== null && l.length < o; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const d of n.getAttributeNames()) if (d.endsWith(ii)) {
          const f = h[a++], u = n.getAttribute(d).split(B), y = /([.?@])?(.*)/.exec(f);
          l.push({ type: 1, index: r, name: y[2], strings: u, ctor: y[1] === "." ? en : y[1] === "?" ? tn : y[1] === "@" ? nn : Ie }), n.removeAttribute(d);
        ...
        if (si.test(n.tagName)) {
          ...
          if (f > 0) {
            ...
            for (let u = 0; u < f; u++) n.append(d[u], me()), q.nextNode(), l.push({ type: 2, index: ++r });
            n.append(d[f], me());
          }
        }
      } else if (n.nodeType === 8) if (n.data === ni) l.push({ type: 2, index: r });
      else {
        let d = -1;
...
let Ji = class {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new dt(r, r.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (c = new sn(r, this, e)), this._$AV.push(c), l = s[++o];
      }
  ...
  _$AI(e, t = this) {
    e = ie(this, e, t), ye(e) ? e === A || e == null || e === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : e !== this._$AH && e !== te && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ki(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    const { values: t, _$litType$: s } = e, n = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = Xe.createElement(ai(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === n) this._$AH.p(t);
    else {
      const r = new Ji(n, this), a = r.u(this.options);
      r.p(t), this.T(a), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = Ut.get(e.strings);
    return t === void 0 && Ut.set(e.strings, t = new Xe(e)), t;
  }
  k(e) {
    ht(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let s, n = 0;
    for (const r of e) n === t.length ? t.push(s = new li(this.O(me()), this.O(me()), this, this.options)) : s = t[n], s._$AI(r), n++;
...
const rn = ct.litHtmlPolyfillSupport;
rn?.(Xe, dt), (ct.litHtmlVersions ??= []).push("3.3.1");
const an = (i, e, t) => {
  const s = t?.renderBefore ?? e;
  let n = s._$litPart$;
  if (n === void 0) {
    const r = t?.renderBefore ?? null;
    s._$litPart$ = n = new dt(e.insertBefore(me(), r), r, void 0, t ?? {});
  }
  return n._$AI(i), n;
};
/**
...
let Q = class extends ee {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = an(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const on = pt.litElementPolyfillSupport;
on?.({ LitElement: Q });
(pt.litElementVersions ??= []).push("4.2.1");
const Je = "langChanged";
function ln(i, e, t) {
  return Object.entries(et(e || {})).reduce((s, [n, r]) => s.replace(new RegExp(`{{[  ]*${n}[  ]*}}`, "gm"), String(et(r))), i);
}
function cn(i, e) {
  const t = i.split(".");
  let s = e.strings;
...
function pn(i) {
  window.dispatchEvent(new CustomEvent(Je, { detail: i }));
}
function un(i, e, t = we) {
  pn({
...
function fn(i, e) {
  ...
  return window.addEventListener(Je, t, e), () => window.removeEventListener(Je, t);
}
async function ci(i, e = we) {
  const t = await e.loader(i, e);
  e.translationCache = {}, un(i, t, e);
}
function gn(i, e, t = we) {
  let s = t.translationCache[i] || (t.translationCache[i] = t.lookup(i, t) || t.empty(i, t));
  return e = e != null ? et(e) : null, e != null ? t.interpolate(s, e, t) : s;
}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const hi = { CHILD: 2 }, mn = (i) => (...e) => ({ _$litDirective$: i, values: e });
let di = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 */
var Ze;
const Pe = window, ne = Pe.trustedTypes, Dt = ne ? ne.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, tt = "$lit$", G = `lit$${(Math.random() + "").slice(9)}$`, pi = "?" + G, yn = `<${pi}>`, K = document, We = () => K.createComment(""), ve = (i) => i === null || typeof i != "object" && typeof i != "function", ui = Array.isArray, wn = (i) => ui(i) || typeof i?.[Symbol.iterator] == "function", Qe = `[ 	
\f\r]`, he = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ot = /-->/g, It = />/g, V = RegExp(`>|${Qe}(?:([^\\s"'>=/]+)(${Qe}*=${Qe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Bt = /'/g, Gt = /"/g, fi = /^(?:script|style|textarea|title)$/i, se = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), Ft = /* @__PURE__ */ new WeakMap(), Z = K.createTreeWalker(K, 129, null, !1);
function gi(i, e) {
...
const vn = (i, e) => {
  ...
  for (let o = 0; o < t; o++) {
    const l = i[o];
    let c, h, d = -1, f = 0;
    for (; f < l.length && (a.lastIndex = f, h = a.exec(l), h !== null); ) f = a.lastIndex, a === he ? h[1] === "!--" ? a = Ot : h[1] !== void 0 ? a = It : h[2] !== void 0 ? (fi.test(h[2]) && (n = RegExp("</" + h[2], "g")), a = V) : h[3] !== void 0 && (a = V) : a === V ? h[0] === ">" ? (a = n ?? he, d = -1) : h[1] === void 0 ? d = -2 : (d = a.lastIndex - h[2].length, c = h[1], a = h[3] === void 0 ? V : h[3] === '"' ? Gt : Bt) : a === Gt || a === Bt ? a = V : a === Ot || a === It ? a = he : (a = V, n = void 0);
    const u = a === V && i[o + 1].startsWith("/>") ? " " : "";
    r += a === he ? l + yn : d >= 0 ? (s.push(c), l.slice(0, d) + tt + l.slice(d) + G + u) : l + G + (d === -2 ? (s.push(void 0), o) : u);
  }
  return [gi(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : "")), s];
};
let it = class mi {
  constructor({ strings: e, _$litType$: t }, s) {
    let n;
    this.parts = [];
    let r = 0, a = 0;
    const o = e.length - 1, l = this.parts, [c, h] = vn(e, t);
    if (this.el = mi.createElement(c, s), Z.currentNode = this.el.content, t === 2) {
    ...
    for (; (n = Z.nextNode()) !== null && l.length < o; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const d = [];
          for (const f of n.getAttributeNames()) if (f.endsWith(tt) || f.startsWith(G)) {
            const u = h[a++];
            if (d.push(f), u !== void 0) {
              const y = n.getAttribute(u.toLowerCase() + tt).split(G), b = /([.?@])?(.*)/.exec(u);
              l.push({ type: 1, index: r, name: b[2], strings: y, ctor: b[1] === "." ? bn : b[1] === "?" ? $n : b[1] === "@" ? kn : Be });
      ...
      } else if (n.nodeType === 8) if (n.data === pi) l.push({ type: 2, index: r });
      else {
        let d = -1;
...
let xn = class {
  ...
  u(e) {
    ...
    Z.currentNode = r;
    let a = Z.nextNode(), o = 0, l = 0, c = n[0];
    for (; c !== void 0; ) {
      if (o === c.index) {
        let h;
        c.type === 2 ? h = new yi(a, a.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(a, c.name, c.strings, this, e) : c.type === 6 && (h = new An(a, this, e)), this._$AV.push(h), c = n[++l];
      }
  ...
  _$AI(e, t = this) {
    e = re(this, e, t), ve(e) ? e === $ || e == null || e === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : e !== this._$AH && e !== se && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : wn(e) ? this.T(e) : this._(e);
  }
  k(e) {
    return this._$AA.parentNode.insertBefore(e, this._$AB);
  }
  ...
  g(e) {
    var t;
    const { values: s, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = it.createElement(gi(n.h, n.h[0]), this.options)), n);
    if (((t = this._$AH) === null || t === void 0 ? void 0 : t._$AD) === r) this._$AH.v(s);
    else {
      const a = new xn(r, this), o = a.u(this.options);
      a.v(s), this.$(o), this._$AH = a;
    }
  }
  _$AC(e) {
    let t = Ft.get(e.strings);
    return t === void 0 && Ft.set(e.strings, t = new it(e)), t;
  }
  T(e) {
    ui(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let s, n = 0;
    for (const r of e) n === t.length ? t.push(s = new wi(this.k(We()), this.k(We()), this, this.options)) : s = t[n], s._$AI(r), n++;
    n < t.length && (this._$AR(s && s._$AB.nextSibling, n), t.length = n);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    var s;
...
const _n = ne ? ne.emptyScript : "";
let $n = class extends Be {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(e) {
    e && e !== $ ? this.element.setAttribute(this.name, _n) : this.element.removeAttribute(this.name);
  }
}, kn = class extends Be {
  constructor(e, t, s, n, r) {
    super(e, t, s, n, r), this.type = 5;
...
jt?.(it, yi), ((Ze = Pe.litHtmlVersions) !== null && Ze !== void 0 ? Ze : Pe.litHtmlVersions = []).push("2.8.0");
/**
 * @license
...
function Sn(i) {
  this._$AN !== void 0 ? (ze(this), this._$AM = i, vi(this)) : this._$AM = i;
}
function Mn(i, e = !1, t = 0) {
...
const Tn = (i) => {
  var e, t, s, n;
  i.type == hi.CHILD && ((e = (s = i)._$AP) !== null && e !== void 0 || (s._$AP = Mn), (t = (n = i)._$AQ) !== null && t !== void 0 || (n._$AQ = Sn));
};
class Ln extends di {
  constructor() {
  ...
  _$AT(e, t, s) {
    super._$AT(e, t, s), vi(this), this.isConnected = e._$AU;
  }
  _$AO(e, t = !0) {
    var s, n;
...
class Nn extends Ln {
   ...
   */
  subscribe() {
    this.langChangedSubscription == null && (this.langChangedSubscription = fn(this.langChanged.bind(this)));
  }
  /**
...
class En extends Nn {
  render(e, t, s) {
    return this.renderValue(() => gn(e, t, s));
  }
}
const m = mn(En);
/**
...
class Vt extends di {
  constructor(e) {
    if (super(e), this.et = $, e.type !== hi.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rn = { attribute: !0, type: String, converter: Ee, reflect: !1, hasChanged: lt }, Pn = (i = Rn, e, t) => {
...
function ae(i) {
  return (e, t) => typeof t == "object" ? Pn(i, e, t) : ((s, n, r) => {
...
var T = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (i) => new RegExp(`^( {0,3}${i})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (i) => new RegExp(`^ {0,${Math.min(3, i - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (i) => new RegExp(`^ {0,${Math.min(3, i - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (i) => new RegExp(`^ {0,${Math.min(3, i - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (i) => new RegExp(`^ {0,${Math.min(3, i - 1)}}#`), htmlBeginRegex: (i) => new RegExp(`^ {0,${Math.min(3, i - 1)}}<(?:[a-z].*>|!--)`, "i") }, Wn = /^(?:[ \t]*(?:\n|$))+/, zn = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, Hn = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, be = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, Un = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, ft = /(?:[*+-]|\d{1,9}[.)])/, _i = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, $i = v(_i).replace(/bull/g, ft).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), Dn = v(_i).replace(/bull/g, ft).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), gt = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, On = /^[^\n]+/, mt = /(?!\s*\])(?:\\.|[^\[\]\\])+/, In = v(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", mt).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), Bn = v(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, ft).getRegex(), Fe = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", yt = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, Gn = v("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", yt).replace("tag", Fe).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), ki = v(gt).replace("hr", be).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Fe).getRegex(), Fn = v(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", ki).getRegex(), wt = { blockquote: Fn, code: zn, def: In, fences: Hn, heading: Un, hr: be, html: Gn, lheading: $i, list: Bn, newline: Wn, paragraph: ki, table: ge, text: On }, qt = v("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", be).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Fe).getRegex(), jn = { ...wt, lheading: Dn, table: qt, paragraph: v(gt).replace("hr", be).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", qt).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Fe).getRegex() }, Vn = { ...wt, html: v(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", yt).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: ge, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: v(gt).replace("hr", be).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", $i).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, qn = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, Zn = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Ai = /^( {2,}|\\)\n(?!\s*$)/, Qn = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, je = /[\p{P}\p{S}]/u, vt = /[\s\p{P}\p{S}]/u, Ci = /[^\s\p{P}\p{S}]/u, Yn = v(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, vt).getRegex(), Si = /(?!~)[\p{P}\p{S}]/u, Kn = /(?!~)[\s\p{P}\p{S}]/u, Xn = /(?:[^\s\p{P}\p{S}]|~)/u, Jn = /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g, Mi = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, es = v(Mi, "u").replace(/punct/g, je).getRegex(), ts = v(Mi, "u").replace(/punct/g, Si).getRegex(), Ti = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", is = v(Ti, "gu").replace(/notPunctSpace/g, Ci).replace(/punctSpace/g, vt).replace(/punct/g, je).getRegex(), ns = v(Ti, "gu").replace(/notPunctSpace/g, Xn).replace(/punctSpace/g, Kn).replace(/punct/g, Si).getRegex(), ss = v("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Ci).replace(/punctSpace/g, vt).replace(/punct/g, je).getRegex(), rs = v(/\\(punct)/, "gu").replace(/punct/g, je).getRegex(), as = v(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), os = v(yt).replace("(?:-->|$)", "-->").getRegex(), ls = v("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", os).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), He = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, cs = v(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", He).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), Li = v(/^!?\[(label)\]\[(ref)\]/).replace("label", He).replace("ref", mt).getRegex(), Ni = v(/^!?\[(ref)\](?:\[\])?/).replace("ref", mt).getRegex(), hs = v("reflink|nolink(?!\\()", "g").replace("reflink", Li).replace("nolink", Ni).getRegex(), xt = { _backpedal: ge, anyPunctuation: rs, autolink: as, blockSkip: Jn, br: Ai, code: Zn, del: ge, emStrongLDelim: es, emStrongRDelimAst: is, emStrongRDelimUnd: ss, escape: qn, link: cs, nolink: Ni, punctuation: Yn, reflink: Li, reflinkSearch: hs, tag: ls, text: Qn, url: ge }, ds = { ...xt, link: v(/^!?\[(label)\]\((.*?)\)/).replace("label", He).getRegex(), reflink: v(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", He).getRegex() }, nt = { ...xt, emStrongRDelimAst: ns, emStrongLDelim: ts, url: v(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i").replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/, text: /^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/ }, ps = { ...nt, br: v(Ai).replace("{2,}", "*").getRegex(), text: v(nt.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, Te = { normal: wt, gfm: jn, pedantic: Vn }, de = { normal: xt, gfm: nt, breaks: ps, pedantic: ds }, us = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Zt = (i) => us[i];
function z(i, e) {
  if (e) {
    if (T.escapeTest.test(i)) return i.replace(T.escapeReplace, Zt);
  } else if (T.escapeTestNoEncode.test(i)) return i.replace(T.escapeReplaceNoEncode, Zt);
  return i;
}
function Qt(i) {
  try {
...
`) };
  ...
  fences(i) {
    ...
    if (e) {
      let t = e[0], s = gs(t, e[3] || "", this.rules);
...
`, i = i.substring(f.length + 1), l = !0), !l) {
          ...
          for (; i; ) {
            let I = i.split(`
`, 1)[0], H;
            if (f = I, this.options.pedantic ? (f = f.replace(this.rules.other.listReplaceNesting, "  "), H = f) : H = f.replace(this.rules.other.tabCharGlobal, "    "), $e.test(f) || E.test(f) || L.test(f) || oe.test(f) || _e.test(f)) break;
            if (H.search(this.rules.other.nonSpaceChar) >= y || !f.trim()) h += `
` + H.slice(y);
            else {
...
` + f;
            ...
            !u && !f.trim() && (u = !0), c += I + `
`, i = i.substring(I.length + 1), d = H.slice(y);
          }
        }
...
`;
  ...
  textRenderer;
  constructor(e) {
    this.options = e || J, this.options.renderer = this.options.renderer || new De(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new bt();
  }
  static parse(e, t) {
...
` + this.renderer.text(o);
  ...
  lexer(i, e) {
    return D.lex(i, e ?? this.defaults);
  }
  parser(i, e) {
  ...
  parseMarkdown(i) {
    return (e, t) => {
      ...
      let a = n.hooks ? n.hooks.provideLexer() : i ? D.lex : D.lexInline, o = n.hooks ? n.hooks.provideParser() : i ? O.parse : O.parseInline;
...
x.options = x.setOptions = function(i) {
  return X.setOptions(i), x.defaults = X.defaults, bi(x.defaults), x;
};
x.getDefaults = ut;
x.defaults = J;
x.use = function(...i) {
  return X.use(...i), x.defaults = X.defaults, bi(x.defaults), x;
};
...
const C = (i, e) => i ? (e || (e = "24px"), p`<ha-icon
  ...
  />`) : p`<ha-icon
      ...
      style="font-size:${e}; width: ${e}; height: ${e}"
    />`, M = (i, e) => i ? (e || (e = "24px"), P`<svg height=${e} width=${e} viewport="0 0 48 48"><path d="${i}" /></svg>`) : P`<svg height=${e} width=${e} viewport="0 0 48 48"><path d="${Ei}" /></svg>`, Ke = (i, e, t) => {
  if (!i)
  ...
  const s = {
    ...
    "clear-night": p`<img src="${ws}" style="font-size:${t}" />`,
    cloudy: p`<img src="${Ss}" style="font-size:${t}" />`,
    fog: p`<img src="${xs}}" style="font-size:${t}" />`,
    hail: p`<img src="${bs}" style="font-size:${t}" />`,
    lightning: p`<img src="${$s}" style="font-size:${t}" />`,
    "lightning-rainy": p`<img src="${_s}" style="font-size:${t}" />`,
    partlycloudy: p`<img src="${vs}" style="font-size:${t}" />`,
    pouring: p`<img src="${Xt}" style="font-size:${t}" />`,
    rainy: p`<img src="${Xt}" style="font-size:${t}" />`,
    snowy: p`<img src="${ks}" style="font-size:${t}" />`,
    "snowy-rainy": p`<img src="${As}" style="font-size:${t}" />`,
    sunny: p`<img src="${Ye}" style="font-size:${t}" />`,
    windy: p`<img src="${Jt}" style="font-size:${t}" />`,
    "windy-variant": p`<img src="${Jt}" style="font-size:${t}" />`,
    exceptional: p`<img src="${Cs}" style="font-size:${t}" />`
  };
  return e === "mdi" ? n[i] || C("mdi:weather-sunny", t) : e === "mdiAsSVG" ? s[i] || p`<img src="${Ye}" />` : r[i] || p`<img src="${Ye}" />`;
};
var Bs = Object.defineProperty, Gs = Object.getOwnPropertyDescriptor, W = (i, e, t, s) => {
  for (var n = s > 1 ? void 0 : s ? Gs(e, t) : e, r = i.length - 1, a; r >= 0; r--)
    (a = i[r]) && (n = (s ? a(e, t, n) : a(n)) || n);
  return s && n && Bs(e, t, n), n;
};
dn({
...
let F = class extends Q {
  ...
  _renderDailyForecastDiagram() {
    ...
    const t = i.length;
    e.length;
    const s = Math.max(180, t * 100), n = t > 0 ? s / t : 100, r = 200, o = n / 24;
    let l = 0;
    ...
    h > 0 && (h = 0);
    const f = 13, u = 64, y = 20, b = 18, N = 8, oe = b + f + N + u + N + 2, _e = 32, $e = 60, E = oe + _e, L = E + $e, I = d - h || 1, H = e.map((g) => typeof g.precipitation == "number" ? g.precipitation : 0);
    console.log(H);
    const Ve = e.map(
      (g) => typeof g.precipitation_probability == "number" ? g.precipitation_probability % 10 : 0
    );
    console.log(Ve);
    const ke = Math.max(...H, ...Ve, 1);
    function Ae(g, w) {
    ...
    function Pi(g) {
      ...
      const S = (g - _.val) / (k.val - _.val), R = Math.round(_.color.r + (k.color.r - _.color.r) * S), U = Math.round(_.color.g + (k.color.g - _.color.g) * S), Me = Math.round(_.color.b + (k.color.b - _.color.b) * S);
      return `rgb(${R},${U},${Me})`;
    }
    const Wi = Ve.map((g, w) => {
      if (!e[w] || !e[w].datetime) return null;
      const _ = new Date(e[w].datetime), { dayIdx: k, hourInDay: S } = Ae(_, l), R = k * n + S * o + o / 2 - Ce / 2, U = ke > 0 ? g / ke * $t : 0;
      return g > 0 ? P`<rect x="${R}" y="${_t - U}" width="${Ce}" height="${U}"
            fill="#988d8dff" opacity="0.4" rx="1.5"/>` : null;
    }), zi = H.map((g, w) => {
      if (!e[w] || !e[w].datetime) return null;
      const _ = new Date(e[w].datetime), { dayIdx: k, hourInDay: S } = Ae(_, l), R = k * n + S * o + o / 2 - Ce / 2, U = ke > 0 ? g / ke * $t : 0, Me = Pi(g);
      return g > 0 ? P`<rect x="${R}" y="${_t - U}" width="${Ce}" height="${U}"
    ...
    if (t > 0)
      for (let g = 0; g < t; g++) {
        const w = g * n + n / 2, _ = b + f, k = _ + N + Ct, S = k + u + N + Ct + 2, R = typeof i[g].templow == "number" ? Math.round(i[g].templow || i[g].temperature - 5) : "", U = typeof i[g].temperature == "number" ? Math.round(i[g].temperature) : "";
        At.push(P`
          <g>
            <!-- Weekday -->
            ...
            <foreignObject x="${w - u / 2}" y="${k}" width="${u}" height="${u}">
                ${Ke(i[g].condition || "", this.config.enable_animate_weather_icons ? "animated" : "mdiAsSVG", u + "px")}
            </foreignObject>
            <!-- Min/Max temp -->
            <text class="weather-temp" x="${w}" y="${S}" text-anchor="middle" font-size="${y}"">${R}°<tspan fill="#aaa"> | </tspan><tspan class="weather-temp">${U}°</tspan></text>
          </g>
        `);
      }
    const St = [], Mt = 5 / I * (L - E), Hi = Math.floor((L - E) / Mt), Se = /* @__PURE__ */ new Set();
    for (let g = 0; g <= Hi; g++)
      Se.add(L - g * Mt);
    if (h > 0) {
      const g = L - (0 - h) / I * (L - E);
    ...
    const Ui = L - (h - h) / I * (L - E);
    return Se.add(Ui), Array.from(Se).sort((g, w) => w - g).forEach((g, w) => {
      St.push(
      ...
      <div class="chart">
        <svg width="100%" height="100%" viewBox="0 0 ${s} ${r}" style="display:block;">
          ...
          <polyline points="${Ri}" fill="none" stroke="#e74c3c" stroke-width="2" />
        </svg>
      </div>
    `;
  }
  ...
  render() {
    if (ci((this.hass.selectedLanguage || this.hass.language || "en").substring(0, 2)), !this.hass || !this.config)
      return p``;
...
let xe = class extends Q {
  ...
  render() {
    ...
    ci((this.hass.selectedLanguage || this.hass.language || "en").substring(0, 2));
    const i = [
      {
        name: "entity",
        required: !0,
